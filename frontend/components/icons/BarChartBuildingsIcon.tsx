...
interface BarChartBuildingsIconProps {
  className?: string;
  color?: string;
...
const BarChartBuildingsIcon: React.FC<BarChartBuildingsIconProps> = ({
  className = "w-6 h-6",
  color,
  style,
  size = 24,
  ...
  >
    ...
    <path d="M9 22V9.5C9 8.67157 8.32843 8 7.5 8H4.5C3.67157 8 3 8.67157 3 9.5V22" stroke="currentColor" strokeWidth="1.5"/>
  </svg>
);

export default BarChartBuildingsIcon;
