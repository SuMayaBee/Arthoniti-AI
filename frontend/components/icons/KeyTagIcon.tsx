...
const KeyTagIcon: React.FC<KeyTagIconProps> = ({
  className = "w-6 h-6",
  color,
  style,
  size = 24,
  ...
  >
    ...
    <path d="M17.8851 8.29304C17.8851 9.50552 16.8982 10.4884 15.6807 10.4884C14.4633 10.4884 13.4763 9.50552 13.4763 8.29304C13.4763 7.08056 14.4633 6.09766 15.6807 6.09766C16.8982 6.09766 17.8851 7.08056 17.8851 8.29304Z" stroke="currentColor" strokeWidth="1.5"/>
  </svg>
);

export default KeyTagIcon;
